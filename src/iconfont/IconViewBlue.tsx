...
let IconViewBlue: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconViewBlue.defaultProps = {
  size: 22,
};

IconViewBlue = React.memo ? React.memo(IconViewBlue) : IconViewBlue;

export default IconViewBlue;
