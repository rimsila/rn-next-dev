...
let IconFont: FunctionComponent<Props> = ({ name, ...rest }) => {
  switch (name) {
    ...
    case 'icon-edit3':
      return <IconEdit3 key="2" {...rest} />;
    case 'icon-EditSquare':
      return <IconEditSquare key="3" {...rest} />;
    case 'icon-edit2':
      return <IconEdit2 key="4" {...rest} />;
    case 'icon-si-glyph-customer-support':
      return <IconSiGlyphCustomerSupport key="5" {...rest} />;
    case 'icon-caidan07':
      return <IconCaidan07 key="6" {...rest} />;
    case 'icon-user':
      return <IconUser key="7" {...rest} />;
    case 'icon-daka-11':
      return <IconDaka11 key="8" {...rest} />;
    case 'icon-test':
      return <IconTest key="9" {...rest} />;
    case 'icon-edit1':
      return <IconEdit1 key="10" {...rest} />;
    case 'icon-add-green':
      return <IconAddGreen key="11" {...rest} />;
    case 'icon-new':
      return <IconNew key="12" {...rest} />;
    case 'icon-add-blue-copy':
      return <IconAddBlueCopy key="13" {...rest} />;
    case 'icon-buy-blue1':
      return <IconBuyBlue1 key="14" {...rest} />;
    case 'icon-merchant-blue':
      return <IconMerchantBlue key="15" {...rest} />;
    case 'icon-buy-black-copy':
      return <IconBuyBlackCopy key="16" {...rest} />;
    case 'icon-all-blue':
      return <IconAllBlue key="17" {...rest} />;
    case 'icon-save-blue':
      return <IconSaveBlue key="18" {...rest} />;
    case 'icon-save':
      return <IconSave key="19" {...rest} />;
    case 'icon-back-pink':
      return <IconBackPink key="20" {...rest} />;
    case 'icon-back-pink-circle':
      return <IconBackPinkCircle key="21" {...rest} />;
    case 'icon-back2':
      return <IconBack2 key="22" {...rest} />;
    case 'icon-back-pink-circle1':
      return <IconBackPinkCircle1 key="23" {...rest} />;
    case 'icon-Back':
      return <IconBack key="24" {...rest} />;
    case 'icon-back-pink1':
      return <IconBackPink1 key="25" {...rest} />;
    case 'icon-reset-yellow':
      return <IconResetYellow key="26" {...rest} />;
    case 'icon-reset':
      return <IconReset key="27" {...rest} />;
    case 'icon-close':
      return <IconClose key="28" {...rest} />;
    case 'icon-clear_circle':
      return <IconClearCircle key="29" {...rest} />;
    case 'icon-clear_circle_outlined':
      return <IconClearCircleOutlined key="30" {...rest} />;
    case 'icon-detail':
      return <IconDetail key="31" {...rest} />;
    case 'icon-eye-blue':
      return <IconEyeBlue key="32" {...rest} />;
    case 'icon-look':
      return <IconLook key="33" {...rest} />;
    case 'icon-view-blue':
      return <IconViewBlue key="34" {...rest} />;
    case 'icon-view-bue':
      return <IconViewBue key="35" {...rest} />;
    case 'icon-look-blue':
      return <IconLookBlue key="36" {...rest} />;
    case 'icon-view-primary':
      return <IconViewPrimary key="37" {...rest} />;
    case 'icon-delete':
      return <IconDelete key="38" {...rest} />;
    case 'icon-Add':
      return <IconAdd key="39" {...rest} />;
    case 'icon-Pointinterestdeletenor':
      return <IconPointinterestdeletenor key="40" {...rest} />;
    case 'icon-Activityproduct':
      return <IconActivityproduct key="41" {...rest} />;
    case 'icon-sale-white':
      return <IconSaleWhite key="42" {...rest} />;
    case 'icon-setting-white':
      return <IconSettingWhite key="43" {...rest} />;
    case 'icon-supplier-white':
      return <IconSupplierWhite key="44" {...rest} />;
    case 'icon-hr-white':
      return <IconHrWhite key="45" {...rest} />;
    case 'icon-next-report-white':
      return <IconNextReportWhite key="46" {...rest} />;
    case 'icon-users-white':
      return <IconUsersWhite key="47" {...rest} />;
    case 'icon-girlfriend':
      return <IconGirlfriend key="48" {...rest} />;
    case 'icon-facebook1':
      return <IconFacebook1 key="49" {...rest} />;
    case 'icon-facebook':
      return <IconFacebook key="50" {...rest} />;
  }
