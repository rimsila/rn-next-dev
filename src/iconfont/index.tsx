...
let IconFont: FunctionComponent<Props> = ({ name, ...rest }) => {
  switch (name) {
    ...
    case 'icon-logout1':
      return <IconLogout1 key="2" {...rest} />;
    case 'icon-log-out':
      return <IconLogOut key="3" {...rest} />;
    case 'icon-dollar-small':
      return <IconDollarSmall key="4" {...rest} />;
    case 'icon-food-o':
      return <IconFoodO key="5" {...rest} />;
    case 'icon-phone':
      return <IconPhone key="6" {...rest} />;
    case 'icon-coffee':
      return <IconCoffee key="7" {...rest} />;
    case 'icon-house_alt':
      return <IconHouseAlt key="8" {...rest} />;
    case 'icon-car':
      return <IconCar key="9" {...rest} />;
    case 'icon-car1':
      return <IconCar1 key="10" {...rest} />;
    case 'icon-radio-unchecked-b-o':
      return <IconRadioUncheckedBO key="11" {...rest} />;
    case 'icon-radoibox_unchecked':
      return <IconRadoiboxUnchecked key="12" {...rest} />;
    case 'icon-edit':
      return <IconEdit key="13" {...rest} />;
    case 'icon-edit3':
      return <IconEdit3 key="14" {...rest} />;
    case 'icon-EditSquare':
      return <IconEditSquare key="15" {...rest} />;
    case 'icon-edit2':
      return <IconEdit2 key="16" {...rest} />;
    case 'icon-si-glyph-customer-support':
      return <IconSiGlyphCustomerSupport key="17" {...rest} />;
    case 'icon-caidan07':
      return <IconCaidan07 key="18" {...rest} />;
    case 'icon-user':
      return <IconUser key="19" {...rest} />;
    case 'icon-daka-11':
      return <IconDaka11 key="20" {...rest} />;
    case 'icon-test':
      return <IconTest key="21" {...rest} />;
    case 'icon-edit1':
      return <IconEdit1 key="22" {...rest} />;
    case 'icon-add-green':
      return <IconAddGreen key="23" {...rest} />;
    case 'icon-new':
      return <IconNew key="24" {...rest} />;
    case 'icon-add-blue-copy':
      return <IconAddBlueCopy key="25" {...rest} />;
    case 'icon-buy-blue1':
      return <IconBuyBlue1 key="26" {...rest} />;
    case 'icon-merchant-blue':
      return <IconMerchantBlue key="27" {...rest} />;
    case 'icon-buy-black-copy':
      return <IconBuyBlackCopy key="28" {...rest} />;
    case 'icon-all-blue':
      return <IconAllBlue key="29" {...rest} />;
    case 'icon-save-blue':
      return <IconSaveBlue key="30" {...rest} />;
    case 'icon-save':
      return <IconSave key="31" {...rest} />;
    case 'icon-back-pink':
      return <IconBackPink key="32" {...rest} />;
    case 'icon-back-pink-circle':
      return <IconBackPinkCircle key="33" {...rest} />;
    case 'icon-back2':
      return <IconBack2 key="34" {...rest} />;
    case 'icon-back-pink-circle1':
      return <IconBackPinkCircle1 key="35" {...rest} />;
    case 'icon-Back':
      return <IconBack key="36" {...rest} />;
    case 'icon-back-pink1':
      return <IconBackPink1 key="37" {...rest} />;
    case 'icon-reset-yellow':
      return <IconResetYellow key="38" {...rest} />;
    case 'icon-reset':
      return <IconReset key="39" {...rest} />;
    case 'icon-close':
      return <IconClose key="40" {...rest} />;
    case 'icon-clear_circle':
      return <IconClearCircle key="41" {...rest} />;
    case 'icon-clear_circle_outlined':
      return <IconClearCircleOutlined key="42" {...rest} />;
    case 'icon-detail':
      return <IconDetail key="43" {...rest} />;
    case 'icon-eye-blue':
      return <IconEyeBlue key="44" {...rest} />;
    case 'icon-look':
      return <IconLook key="45" {...rest} />;
    case 'icon-view-blue':
      return <IconViewBlue key="46" {...rest} />;
    case 'icon-view-bue':
      return <IconViewBue key="47" {...rest} />;
    case 'icon-look-blue':
      return <IconLookBlue key="48" {...rest} />;
    case 'icon-view-primary':
      return <IconViewPrimary key="49" {...rest} />;
    case 'icon-delete':
      return <IconDelete key="50" {...rest} />;
    case 'icon-Add':
      return <IconAdd key="51" {...rest} />;
    case 'icon-Pointinterestdeletenor':
      return <IconPointinterestdeletenor key="52" {...rest} />;
    case 'icon-Activityproduct':
      return <IconActivityproduct key="53" {...rest} />;
    case 'icon-sale-white':
      return <IconSaleWhite key="54" {...rest} />;
    case 'icon-setting-white':
      return <IconSettingWhite key="55" {...rest} />;
    case 'icon-supplier-white':
      return <IconSupplierWhite key="56" {...rest} />;
    case 'icon-hr-white':
      return <IconHrWhite key="57" {...rest} />;
    case 'icon-next-report-white':
      return <IconNextReportWhite key="58" {...rest} />;
    case 'icon-users-white':
      return <IconUsersWhite key="59" {...rest} />;
    case 'icon-girlfriend':
      return <IconGirlfriend key="60" {...rest} />;
    case 'icon-facebook1':
      return <IconFacebook1 key="61" {...rest} />;
    case 'icon-facebook':
      return <IconFacebook key="62" {...rest} />;
  }
